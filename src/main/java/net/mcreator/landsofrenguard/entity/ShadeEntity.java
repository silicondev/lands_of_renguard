...
public class ShadeEntity extends Monster {
	public ShadeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(LandsOfRenguardModEntities.SHADE.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(6, new PanicGoal(this, 1.7));
	}
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.wither.shoot"));
	}
	...
	public static void init() {
		SpawnPlacements.register(LandsOfRenguardModEntities.SHADE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
