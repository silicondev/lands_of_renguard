...
public class LandsOfRenguardModItems {
	...
	public static final RegistryObject<Item> HUMAN_SPAWN_EGG = REGISTRY.register("human_spawn_egg", () -> new ForgeSpawnEggItem(LandsOfRenguardModEntities.HUMAN, -1, -1, new Item.Properties()));
